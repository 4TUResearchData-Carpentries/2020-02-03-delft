...
venue: "@TU Delft"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Nicolas Dintzner", "Claudia Engelhardt", "Kees den Heijer", "Barbara Vreede"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jeff Love", "Yan Wang", "Mateusz Kuzak", "Masha Rudneva", "Esther Plomp", "Lora Armstrong"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
